...
if __name__ == '__main__':
    ...
    while money_in_dollars > 0:
        ...
        if spent == 0:
            money_in_dollars -= spent
            messagebox.showinfo(None, message = 'You have ' + str(money_in_dollars) + " dollars left")
            break
    ...
    if money_in_dollars == 0:
        messagebox.showinfo(None, message="Congratulations! You maximized your money.")
    # TODO) If there is a negative amount of money, tell the user they
    #  overspent!
    elif money_in_dollars < 0:
        messagebox.showinfo(None, message="Oops! You overspent the amount of money you had. You're in debt.")
